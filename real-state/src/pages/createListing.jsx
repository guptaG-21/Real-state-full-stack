...
const CreateListing = () => {
  ...
  return (
    <main className='p-5 max-w-4xl mx-auto'>
      <h1 className='text-3xl text-center text-black font-semibold my-7 p-2 rounded-lg'>
        Create Listing:
      </h1>
        ...
        <div className='flex flex-col flex-1 gap-2'>
          ...
          <div className='flex gap-2'>
            ...
            <button
              ...
              className='bg-green-600 text-white rounded-lg p-2 uppercase font-semibold hover:shadow-xl disabled:opacity-80 text-md'
            >
          ...
          <button
            ...
            className='p-3 bg-blue-500 text-white uppercase font-semibold rounded-lg hover:shadow-xl disabled:opacity-80 text-md '
          >
